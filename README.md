...
gcc -Wall -o server server_windows.c

# Kompajliranje kontrolnog klijenta
gcc -Wall -o ctrl control_client_windows.c
```
...
- `server_windows.c` - UDP posrednik server (preimenujte u `server.c` ako želite)
- `control_client_windows.c` - Kontrolni klijent za upravljanje posrednikom (preimenujte u `control_client.c` ako želite)
